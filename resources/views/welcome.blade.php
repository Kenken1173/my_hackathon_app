            ...
            <div class="goal-card bg-white rounded-xl p-4 shadow-sm border border-gray-100" data-status="active"
                ...
                <div class="flex items-start justify-between mb-3">
                    <div class="flex-1 min-w-0">
                        ...
                        <h3 class="font-bold text-gray-900 text-lg mb-1 truncate">TOEICで800点を取る</h3>
                        <p class="text-sm text-gray-600 mb-3">期限：2024年12月31日</p>
                    </div>
                    ...
                    <div class="relative w-16 h-16 ml-4">
                        <svg class="progress-ring w-16 h-16">
                            ...
                            <circle class="progress-ring-circle" cx="32" cy="32" r="28" stroke="#22C55E"
                                stroke-width="4" fill="none" stroke-dasharray="87.96 175.93" />
                        </svg>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-xs text-gray-500">6タスク中 3完了</div>
                </div>
            </div>
